...
#include <plugins/wallace/gui/WallaceGui.h>
...
void CalculateElasticDisplacementsModifierEditor::createUI(const RolloutInsertionParameters& rolloutParams)
{
    ...
    //This is the box for affine mapping
    ...
    sublayout = new QGridLayout(burgersContentGroupBox);
    sublayout->setContentsMargins(4,4,4,4);
    sublayout->setSpacing(4);

    //This Makes the UI correct - need to properly link to the parameter
    // need an updateParameterValue() and a connect to onSpinnerDrag, etc.
    for(int col = 0; col < 3; col++) {
        int row = 0;
        Vector3ParameterUI* burgersUI = new Vector3ParameterUI(this, PROPERTY_FIELD(CalculateElasticDisplacementsModifier::burgersContent), col);
        sublayout->addLayout(burgersUI->createFieldLayout(), row+1, col*3+0);
    }
...
******************************************************************************/
//void CalculateElasticDisplacementsModifierEditor::onSpinnerValueChanged()
//{
...
******************************************************************************/
//void CalculateElasticDisplacementsModifierEditor::updateParameterValue()
//{
//    CalculateElasticDisplacementsModifier* mod = dynamic_object_cast<CalculateElasticDisplacementsModifier>(editObject());
//    if(!mod) return;
//
...
******************************************************************************/
//void CalculateElasticDisplacementsModifierEditor::onSpinnerDragStart()
//{
...
******************************************************************************/
//void CalculateElasticDisplacementsModifierEditor::onSpinnerDragStop()
//{
//    OVITO_ASSERT(dataset()->undoStack().isRecording());
...
******************************************************************************/
//void CalculateElasticDisplacementsModifierEditor::onSpinnerDragAbort()
//{
//    OVITO_ASSERT(dataset()->undoStack().isRecording());
